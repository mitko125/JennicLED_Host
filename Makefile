...
#V2_0 добавен е втори такмер вкл./изкл. заради високата цeна на тока (свети само вечер и сутрин)
...
#V5 заменя всички по-стари даже и при стари и нови PC програми  		46 броя са в Твърдица
